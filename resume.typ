...
산업기능요원으로서 게임 클라이언트 엔지니어로 일한 3년의 경험이 있지만 웹 프론트엔드로 커리어를 전환하려고 합니다. 고등학생 시절부터 게임 프로그래밍을 꾸준히 해오다, 사람들에게 도움이 되는 서비스를 더욱 쉽게 배포하고 공유할 수 있는 웹 프론트엔드에 매력을 느끼고 관심 분야를 옮겨왔습니다. \
